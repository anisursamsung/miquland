...
#include "ui/widgets/cell_item_model.hpp"
#include "ui/widgets/table_view.hpp"
#include "ui/widgets/text_input_view.hpp"
...
private:
    ...
    void filter_items();
    void launch_selected_app(const CellItemModel& item);

    Server* m_server = nullptr;
    struct wlr_scene_buffer* m_scene_buffer = nullptr;
    std::unique_ptr<CairoBuffer> m_buffer;
    std::unique_ptr<TableView> m_table_view;
    TextInputView m_search_input;
